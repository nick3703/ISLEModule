...
expfitHawkesSim <- fitdistr(simRecs_Hawkes$p,"exponential")
...
We can estimate the Hessian, $H_M$, and use the result to produce confidence intervals for the parameters.
...
Cavaliere, G., Lu, Y., Rahbek, A., and Østergaard, Jacob (2021). Bootstrap inference for Hawkes and general point processes.  Discussion Paper Series, U. Copenhagen Economics. Available at SSRN: https://ssrn.com/abstract=3844552 or http://dx.doi.org/10.2139/ssrn.3844552
...
Ogata, Y. (1978). The asymptotic behavior of maximum likelihood estimators
for stationary point processes. Annals of the Institute of Statistical Mathe-
matics, 30(2), 243{261.
