...
![NYTimes.](NYTIMESarticle.png){width=50%}
...
![Rod Aloha Run San Diego, 2019 Age Group 2nd.](aloharun.jpg){width=50%}
...
```{r}
set.seed(13)
optMarathon<-mle(daysfromstart_mod2,"Exponential",111)  # end date picked number greater than longest times
