...
- Hawkes generally "better" before 1947

- Since 1947 constant rate model seems appropriate

- Perhaps we are not in an era of records for Men's marathon?
...
# Possibly Hession/Covariance Uncertainty in parameter estimates

- will look at implementing Ogata result (Cavaliere paper theorem 2) maybe?
- below is a small start...Hessian and inverse...can get Jacobian too
